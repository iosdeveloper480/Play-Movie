...
//  Banner.swift
//
//  Created by Waqas Ali on 7/27/15.
...
open class Banner: UIView {
    ...
    //show(_ view: UIView? = Banner.topWindow(), duration: TimeInterval? = nil)
    open func show(_ view: UIView?, duration: TimeInterval? = nil) {
...
extension UIView {
    ...
    func constraintWithAttribute(_ attribute: NSLayoutConstraint.Attribute, _ relation: NSLayoutConstraint.Relation, to otherAttribute: NSLayoutConstraint.Attribute, of item: AnyObject? = nil, multiplier: CGFloat = 1.0, constant: CGFloat = 0.0) -> NSLayoutConstraint {
        ...
        if #available(iOS 11.0, *) {
            return NSLayoutConstraint(item: self, attribute: attribute, relatedBy: relation, toItem: item?.safeAreaLayoutGuide ?? self, attribute: otherAttribute, multiplier: multiplier, constant: constant)
        } else {
    ...
    func constraintWithAttribute(_ attribute: NSLayoutConstraint.Attribute, _ relation: NSLayoutConstraint.Relation, to item: AnyObject, multiplier: CGFloat = 1.0, constant: CGFloat = 0.0) -> NSLayoutConstraint {
        self.translatesAutoresizingMaskIntoConstraints = false
        if #available(iOS 11.0, *) {
            return NSLayoutConstraint(item: self, attribute: attribute, relatedBy: relation, toItem: item.safeAreaLayoutGuide, attribute: attribute, multiplier: multiplier, constant: constant)
        } else {
            // Fallback on earlier versions
...
//        if #available(iOS 11.0, *) {
            return attributes.map {
                self.constraintWithAttribute($0, relation, to: item, multiplier: multiplier, constant: constant)
            }
//        } else {
//            return attributes.map {
//                // Fallback on earlier versions
